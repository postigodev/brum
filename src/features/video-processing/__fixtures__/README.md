...
`h264-video.mp4` and `h264-aac.mp4` exercise supported packet-copy remuxing. The AAC fixture deliberately compensates for the encoder's 1024-sample priming delay so both tracks share a near-zero origin and one-second span, as required by the spike contract. `unsupported-video.mp4` verifies explicit rejection of non-H.264 video.
